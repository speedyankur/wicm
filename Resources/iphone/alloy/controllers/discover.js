function Controller() {
    ...
    $.__views.portrait.add($.__views.__alloyId16);
    ...
    $.__views.portrait.add($.__views.__alloyId17);
    ...
    $.__views.column1.add($.__views.__alloyId18);
    ...
    $.__views.column1.add($.__views.__alloyId19);
    goToPostScreen ? $.__views.__alloyId19.addEventListener("click", goToPostScreen) : __defers["$.__views.__alloyId19!click!goToPostScreen"] = true;
    try {
        $.__views.__alloyId19.addEventListener("touchstart", Alloy.Globals.buttonFocused);
    } catch (e) {
        __defers["$.__views.__alloyId19!touchstart!Alloy.Globals.buttonFocused"] = true;
    }
    try {
        $.__views.__alloyId19.addEventListener("touchend", Alloy.Globals.buttonBlurred);
    } catch (e) {
        __defers["$.__views.__alloyId19!touchend!Alloy.Globals.buttonBlurred"] = true;
    }
    ...
    __defers["$.__views.__alloyId19!click!goToPostScreen"] && $.__views.__alloyId19.addEventListener("click", goToPostScreen);
    __defers["$.__views.__alloyId19!touchstart!Alloy.Globals.buttonFocused"] && $.__views.__alloyId19.addEventListener("touchstart", Alloy.Globals.buttonFocused);
    __defers["$.__views.__alloyId19!touchend!Alloy.Globals.buttonBlurred"] && $.__views.__alloyId19.addEventListener("touchend", Alloy.Globals.buttonBlurred);
    _.extend($, exports);
}
