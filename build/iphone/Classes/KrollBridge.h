...
@interface WhichiscoolerObject : KrollCoverageObject {
#else
@interface WhichiscoolerObject : KrollObject {
#endif
@private
...
extern NSString * Whichiscooler$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	WhichiscoolerObject *_whichiscooler;
    KrollObject* console;
	BOOL shutdown;
