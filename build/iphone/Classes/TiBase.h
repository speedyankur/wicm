...
// in simulator we redefine to format for Whichiscooler Developer console
...
{\
	NSString * exceptionName = [@"org.whichiscooler." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.whichiscooler";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIWhichiscoolerNativeItemNone = -1, 
	UIWhichiscoolerNativeItemSpinner = -2,
	UIWhichiscoolerNativeItemProgressBar = -3,
	
	UIWhichiscoolerNativeItemSlider = -4,
	UIWhichiscoolerNativeItemSwitch = -5,
	UIWhichiscoolerNativeItemMultiButton = -6,
	UIWhichiscoolerNativeItemSegmented = -7,
	
	UIWhichiscoolerNativeItemTextView = -8,
	UIWhichiscoolerNativeItemTextField = -9,
	UIWhichiscoolerNativeItemSearchBar = -10,
	
	UIWhichiscoolerNativeItemPicker = -11,
	UIWhichiscoolerNativeItemDatePicker = -12,
	
	UIWhichiscoolerNativeItemInfoLight = -13,
	UIWhichiscoolerNativeItemInfoDark = -14,
	
	UIWhichiscoolerNativeItemDisclosure = -15,
	
	UIWhichiscoolerNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all Whichiscooler instances of
