...
//Rare exceptions to indicate a bug in the _whichiscooler code (Eg, function that a subclass should have implemented)
...
/**
 The base class for Whichiscooler proxies.
 */
