function Controller() {
    ...
    postIt ? $.__views.__alloyId122.addEventListener("click", postIt) : __defers["$.__views.__alloyId122!click!postIt"] = true;
    try {
        $.__views.__alloyId122.addEventListener("touchstart", Alloy.Globals.objectOpacityOnFocused);
    } catch (e) {
        __defers["$.__views.__alloyId122!touchstart!Alloy.Globals.objectOpacityOnFocused"] = true;
    }
    try {
        $.__views.__alloyId122.addEventListener("touchend", Alloy.Globals.objectOpacityOnBlurred);
    } catch (e) {
        __defers["$.__views.__alloyId122!touchend!Alloy.Globals.objectOpacityOnBlurred"] = true;
    }
    ...
    postIt ? $.__views.__alloyId123.addEventListener("click", postIt) : __defers["$.__views.__alloyId123!click!postIt"] = true;
    try {
        $.__views.__alloyId123.addEventListener("touchstart", Alloy.Globals.objectOpacityOnFocused);
    } catch (e) {
        __defers["$.__views.__alloyId123!touchstart!Alloy.Globals.objectOpacityOnFocused"] = true;
    }
    try {
        $.__views.__alloyId123.addEventListener("touchend", Alloy.Globals.objectOpacityOnBlurred);
    } catch (e) {
        __defers["$.__views.__alloyId123!touchend!Alloy.Globals.objectOpacityOnBlurred"] = true;
    }
    ...
    __defers["$.__views.__alloyId122!click!postIt"] && $.__views.__alloyId122.addEventListener("click", postIt);
    __defers["$.__views.__alloyId122!touchstart!Alloy.Globals.objectOpacityOnFocused"] && $.__views.__alloyId122.addEventListener("touchstart", Alloy.Globals.objectOpacityOnFocused);
    __defers["$.__views.__alloyId122!touchend!Alloy.Globals.objectOpacityOnBlurred"] && $.__views.__alloyId122.addEventListener("touchend", Alloy.Globals.objectOpacityOnBlurred);
    __defers["$.__views.__alloyId123!click!postIt"] && $.__views.__alloyId123.addEventListener("click", postIt);
    __defers["$.__views.__alloyId123!touchstart!Alloy.Globals.objectOpacityOnFocused"] && $.__views.__alloyId123.addEventListener("touchstart", Alloy.Globals.objectOpacityOnFocused);
    __defers["$.__views.__alloyId123!touchend!Alloy.Globals.objectOpacityOnBlurred"] && $.__views.__alloyId123.addEventListener("touchend", Alloy.Globals.objectOpacityOnBlurred);
    _.extend($, exports);
}
