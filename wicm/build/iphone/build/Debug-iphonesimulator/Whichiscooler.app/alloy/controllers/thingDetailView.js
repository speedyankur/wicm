function Controller() {
    ...
    $.__views.thing.add($.__views.__alloyId104);
    ...
    $.__views.__alloyId104.add($.__views.thingDetailsLabel);
    ...
    $.__views.detail.add($.__views.__alloyId105);
    ...
    $.__views.__alloyId105.add($.__views.imageLabel);
    ...
    $.__views.__alloyId105.add($.__views.hypen);
    ...
    $.__views.__alloyId105.add($.__views.price);
    ...
    $.__views.detail.add($.__views.__alloyId106);
    ...
    $.__views.__alloyId106.add($.__views.scoreLabel);
    ...
    $.__views.__alloyId106.add($.__views.score);
    ...
    $.__views.__alloyId106.add($.__views.statBegin);
    ...
    $.__views.__alloyId106.add($.__views.win);
    ...
    $.__views.__alloyId106.add($.__views.winText);
    ...
    $.__views.__alloyId106.add($.__views.loss);
    ...
    $.__views.__alloyId106.add($.__views.lossText);
    ...
    $.__views.detail.add($.__views.__alloyId107);
    ...
    $.__views.__alloyId107.add($.__views.commentField);
    ...
    $.__views.__alloyId107.add($.__views.postButton);
    ...
    $.__views.tdv.add($.__views.__alloyId108);
    $.__views.bottomBarButtons = Ti.UI.createView({
        width: Ti.UI.SIZE,
        id: "bottomBarButtons",
        layout: "horizontal"
    });
    $.__views.__alloyId108.add($.__views.bottomBarButtons);
    ...
    $.__views.bottomBarButtons.add($.__views.__alloyId109);
    favThisThing ? $.__views.__alloyId109.addEventListener("click", favThisThing) : __defers["$.__views.__alloyId109!click!favThisThing"] = true;
    ...
    $.__views.bottomBarButtons.add($.__views.__alloyId110);
    ...
    $.__views.bottomBarButtons.add($.__views.__alloyId111);
    flagThisThing ? $.__views.__alloyId111.addEventListener("click", flagThisThing) : __defers["$.__views.__alloyId111!click!flagThisThing"] = true;
    ...
    __defers["$.__views.__alloyId109!click!favThisThing"] && $.__views.__alloyId109.addEventListener("click", favThisThing);
    __defers["$.__views.__alloyId111!click!flagThisThing"] && $.__views.__alloyId111.addEventListener("click", flagThisThing);
    _.extend($, exports);
}
