function Controller() {
    ...
    $.__views.portrait.add($.__views.__alloyId88);
    ...
    $.__views.column1.add($.__views.__alloyId90);
    ...
    try {
        $.__views.__alloyId91.addEventListener("touchstart", Alloy.Globals.buttonFocused);
    } catch (e) {
        __defers["$.__views.__alloyId91!touchstart!Alloy.Globals.buttonFocused"] = true;
    }
    try {
        $.__views.__alloyId91.addEventListener("touchend", Alloy.Globals.buttonBlurred);
    } catch (e) {
        __defers["$.__views.__alloyId91!touchend!Alloy.Globals.buttonBlurred"] = true;
    }
    goToLogin ? $.__views.__alloyId91.addEventListener("click", goToLogin) : __defers["$.__views.__alloyId91!click!goToLogin"] = true;
    ...
    __defers["$.__views.__alloyId91!touchstart!Alloy.Globals.buttonFocused"] && $.__views.__alloyId91.addEventListener("touchstart", Alloy.Globals.buttonFocused);
    __defers["$.__views.__alloyId91!touchend!Alloy.Globals.buttonBlurred"] && $.__views.__alloyId91.addEventListener("touchend", Alloy.Globals.buttonBlurred);
    __defers["$.__views.__alloyId91!click!goToLogin"] && $.__views.__alloyId91.addEventListener("click", goToLogin);
    _.extend($, exports);
}
