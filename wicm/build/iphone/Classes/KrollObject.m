...
//@interface WhichiscoolerObject : NSObject
//@end

@interface WhichiscoolerObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[WhichiscoolerObject class]])
		{
			for (NSString *key in [[(WhichiscoolerObject*)o modules] allKeys])
			{
