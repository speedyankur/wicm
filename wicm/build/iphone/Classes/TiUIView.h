...
/**
 Base class for all Whichiscooler views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the Whichiscooler view hierarchy (such as wrapped iOS UIViews) was touched.
